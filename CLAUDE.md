...
|---|---|---|
| `terrario/` | Terrário — simulador de civilização: tribos que plantam, criam gado cercado, mineram, guerreiam, se aliam, federam-se em nações, atravessam o mar e calçam cidade | sim, dois |
