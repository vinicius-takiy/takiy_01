...
const VERSAO = 'linha-de-frente-v1';
const ARQUIVOS = [
  './', './index.html', './manifest.webmanifest',
  './vendor/three.module.min.js',
  './src/main.js', './src/level.js', './src/player.js', './src/enemy.js',
  './src/weapon.js', './src/collision.js', './src/fx.js', './src/hud.js',
  './src/input.js', './src/audio.js', './src/settings.js',
